...
from models import QuestionBlock, Enquete, Question, QuestionChoice, Answer, ProfileText, Invulmoment
...
def addScore(user, id_of_last_block, id_invulmoment):
	...
	profielObject = profielObject.create(user=user, invulmoment=id_invulmoment)
